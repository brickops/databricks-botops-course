...
# MAGIC
# MAGIC We will do our tasks in the context of the folder representing the tripbot data pipeline or flow:
# MAGIC
# MAGIC `orgs/acme/domains/transport/projects/taxinyc/flows/ml/tripbot/`
# MAGIC
...
# MAGIC
# MAGIC You can explore the structure here in Databricks, or more easily [in the repo with a browser](https://github.com/paalvibe/databricks-botops-course).
