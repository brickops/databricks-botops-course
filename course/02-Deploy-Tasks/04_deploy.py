...
# MAGIC
# MAGIC Look at `orgs/acme/domains/transport/projects/taxinyc/flows/ml/tripbot/deployment.yml`.
...
# MAGIC
# MAGIC 1. Go to the notebook orgs/acme/domains/transport/projects/taxinyc/flows/ml/tripbot/deploy
