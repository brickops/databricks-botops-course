...
print("len(SERVICE_PRINCIPAL_CLIENT_ID): " + len(SERVICE_PRINCIPAL_CLIENT_ID))

def get_workspace_client():
    host = "dbc-639f4875-165d.cloud.databricks.com"
    # host = os.getenv("BOTOPSGENIE_DATABRICKS_HOST")
    print(f"host: {host}")
    print("before token len(SERVICE_PRINCIPAL_CLIENT_ID): " + len(SERVICE_PRINCIPAL_CLIENT_ID))
